...
def create_loaders(data,batch_train=4,batch_dev=4):
  """
  ...
  for i in range(len(data)):
    cluster_dataloaders[i] = (DataLoader(create_dataset(i,0),batch_train),DataLoader(create_dataset(i,1),batch_dev))
